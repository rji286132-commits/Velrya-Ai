...
export function Preview({ chatId }: { chatId: string | null }) {
  ...
  if (!chatId) {
    return (
      <div className="h-full min-h- w-full flex items-center justify-center bg-[#0f0f18]/50 backdrop-blur p-6">
        <div className="text-center">
          <div className="w-14 h-14 rounded- bg-[#12121f] border border-white/10 flex items-center justify-center mx-auto mb-3 text-2xl shadow-[0_8px_20px_rgba(0,0,0,0.4)]">🖥️</div>
  ...
  return (
    <div className="h-full min-h- md:min-h-0 w-full flex flex-col bg-[#08080f] border-l border-white/10">
          ...
          <div className="h-full overflow-auto p-3 md:p-4 bg-[#08080f] space-y-4">
            {html && (
              <div className="bg-[#12121f]/80 border border-white/10 rounded-xl overflow-hidden">
                <div className="text- font-bold text-gray-400 px-3 py-2 border-b border-white/10">HTML • VELRYA AI</div>
                <pre className="p-3 text-xs text-gray-300 overflow-auto max-h-">
                  <code>{html}</code>
                </pre>
              </div>
            )}
            {css && (
              <div className="bg-[#12121f]/80 border border-white/10 rounded-xl overflow-hidden">
                <div className="text- font-bold text-gray-400 px-3 py-2 border-b border-white/10">CSS</div>
                <pre className="p-3 text-xs text-gray-300 overflow-auto max-h-">
                  <code>{css}</code>
                </pre>
              </div>
            ...
            {js && (
              <div className="bg-[#12121f]/80 border border-white/10 rounded-xl overflow-hidden">
                <div className="text- font-bold text-gray-400 px-3 py-2 border-b border-white/10">JavaScript</div>
                <pre className="p-3 text-xs text-gray-300 overflow-auto max-h-">
                  <code>{js}</code>
                </pre>
              </div>
